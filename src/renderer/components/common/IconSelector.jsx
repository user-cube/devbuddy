...
const IconSelector = ({ value, onChange, placeholder = "Select an icon" }) => {
  ...
  const icons = [
    ...
    { name: 'file-word', icon: 'fas fa-file-word', label: 'Word' },
    { name: 'file-excel', icon: 'fas fa-file-excel', label: 'Excel' },
    { name: 'file-powerpoint', icon: 'fas fa-file-powerpoint', label: 'PowerPoint' },
    { name: 'file-video', icon: 'fas fa-file-video', label: 'Video' },
    { name: 'file-audio', icon: 'fas fa-file-audio', label: 'Audio' },
    { name: 'file-archive', icon: 'fas fa-file-archive', label: 'Archive' },
